...
function tracking_woocommerce_email_order_meta_fields( $fields, $sent_to_admin, $order ) { 
    ...
    $html .= '</tbody></table><table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: \'Helvetica Neue\', Helvetica, Roboto, Arial, sans-serif; color: #797a7c; border: 1px solid #e5e5e5;border-top:0;border-bottom:0;" border="1"><thead><th class="td" scope="col" style="text-align: left; color: #797a7c; border: 1px solid #e5e5e5; padding: 12px;">Link per il tracciamento</th><th class="td" scope="col" style="text-align: left; color: #797a7c; border: 1px solid #e5e5e5; padding: 12px;">Data di spedizione</th></thead><tbody><tr class="order_item">';
