...
var iro = angular.module('iro', ['ngSanitize', 'matchMedia', 'angular-click-outside', 'ui.router', 'angularLoad', 'ngAnimate', 'angular-bind-html-compile', 'ngCart', 'ngCookies', 'youtube-embed']);
const vars = vars;
