	...
	<?php if ( 1 < $customer_orders->max_num_pages ) : ?>
		<div class="account__pagination">
			<?php if ( 1 !== $current_page ) : ?>
				<a class="account__button account__button--prev account__button-light account__button--slim" ui-sref="app.account({path : '<?php echo basename(wc_get_endpoint_url( 'orders', $current_page + 1 ) ); ?>'}" href="<?php echo esc_url( wc_get_endpoint_url( 'orders', $current_page - 1 ) ); ?>"><?php _e( 'Previous', 'woocommerce' ); ?></a>
			<?php endif; ?>

			<?php if ( intval( $customer_orders->max_num_pages ) !== $current_page ) : ?>
				<a class="account__button account__button--next account__button-light account__button--slim" href="<?php echo esc_url( wc_get_endpoint_url( 'orders', $current_page + 1 ) ); ?>" ui-sref="app.account({path : '<?php echo basename(wc_get_endpoint_url( 'orders', $current_page + 1 ) ); ?>'}"><?php _e( 'Next', 'woocommerce' ); ?></a>
			<?php endif; ?>
		</div>
	<?php endif; ?>
