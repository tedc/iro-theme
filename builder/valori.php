...
<section class="<?php echo $name; ?>">
	...
	<div class="<?php echo $name; ?>__main">
		<div class="<?php echo $name; ?>__container swiper-container" scroller="values" options="{'grabCursor' : true, magnifyEffect: {slideResizerClass : '.<?php echo $name; ?>__icon'}, init: false, slideToClickedSlide : true, speed : 750, loop: true, loopedSlides : 4, centeredSlides : true}">
