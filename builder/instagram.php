...
<div class="instagram" ng-instagram strings="{s : ['<?php _e('secondo', 'iro'); ?>', '<?php _e('secondi', 'iro'); ?>'], m : ['<?php _e('minuto', 'iro'); ?>', '<?php _e('minuti', 'iro'); ?>'], h :['<?php _e('ora', 'iro'); ?>', '<?php _e('ore', 'iro'); ?>'], d :['<?php _e('giorno', 'iro'); ?>', '<?php _e('giorni', 'iro'); ?>'], mo :['<?php _e('mese', 'iro'); ?>', '<?php _e('mesi', 'iro'); ?>'], y :['<?php _e('anno', 'iro'); ?>', '<?php _e('anni', 'iro'); ?>'], ago: '<?php _e('fa', 'iro'); ?>'}" obj="<?php echo htmlspecialchars( wp_json_encode(instagram_object() ) ); ?>">
