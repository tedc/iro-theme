...
<?php while (have_posts()) : the_post(); ?>
	...
	<div class="alert alert--grow-lg-bottom alert--shrink alert--mw-large alert--aligncenter" ng-agile-thanks="<?php $date = get_field('popup_expire', $promo_id);$date = new DateTime($date);echo $date->format('Y-m-d'); ?>T<?php echo $date->format('H:i:s'); ?>" cookie-name="_promo_<?php echo $promo_id; ?>">
